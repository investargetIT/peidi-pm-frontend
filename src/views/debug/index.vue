...
import cardDetail from "@/views/classify/cardDetail.vue";
import {
  omsGetShops,
  newTask,
  getEnum,
...
import { removeDuplicates, extractEmplId, extractInfo, splitTaskType } from "@/views/classify/utils";
import { jsonp } from "vue-jsonp";
import {
  testAllIPs,
  default_upload_url,
  chaohuiDownload
} from "../../utils/chaohuiapi_";
import Axios from "axios";
import { message } from "@/utils/message";
import { ElLoading, ElMessageBox } from "element-plus";
import WorkerDetailModal from "@/views/classify/workerDetailModal.vue";
  ...
  <div class="container1">
    <el-form label-position="top" label-width="auto" v-loading="loading" element-loading-text="上传中。。。" ref="formRef"
      ...
      <el-form-item label="需求发起人" prop="contacters">
        ...
        <el-button :disabled="isEdit" @click="choosePerson('contacters')">选择需求发起人</el-button>
        <div class="helpers">
    ...
    <WorkerDetailModal :workersData="newTaskData.workers" @refresh="workerDetailModalRefresh"
      ref="workerDetailModalRef" />
    <!-- </template> -->
  </div>
</template>
