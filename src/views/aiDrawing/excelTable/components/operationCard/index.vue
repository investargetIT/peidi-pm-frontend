...
import { MAX_PIC_COUNT, GRSAI_MODEL_NAME } from '@/views/aiDrawing/excelTable/utils/constants';
...
<template>
  <el-card shadow="never" style="border-radius:10px;" class="mt-[10px]">
    ...
    <div class="flex justify-between">
      ...
      <el-button type="primary" @click="handleGenerateImagesClick" :loading="loading" :disabled="isEdit">
        生成图片
      </el-button>
    </div>
  </el-card>
