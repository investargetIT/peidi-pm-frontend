          ...
          <div>
            <el-form :model="aiDrawingForm" label-width="auto" style="max-width: 600px">
              ...
              <el-form-item label="产品卖点-高亮">
                <el-input v-model="aiDrawingForm.highlightedSellingPoints" placeholder="特色酥骨工艺" />
              </el-form-item>
              <el-form-item label="产品卖点-全部">
                <el-input v-model="aiDrawingForm.normalSellingPoints" placeholder="特色酥骨工艺 蜜汁兔脊" />
              </el-form-item>
              <el-form-item label="产品名">
                <el-input v-model="aiDrawingForm.productName" placeholder="兔脊骨120g" />
              </el-form-item>
              <el-form-item label="产品图片">
                <DevUpLoad v-model="aiDrawingForm.productImage" :limit="1" />
              </el-form-item>
              <el-form-item label="全场满赠-标题">
                <el-input v-model="aiDrawingForm.fullGiftTitle" placeholder="全场满199送" />
              </el-form-item>
              <el-form-item label="全场满赠-描述">
                <el-input v-model="aiDrawingForm.fullGiftDescription" placeholder="爵宴狗粮随行装试吃（50g*4）" />
              </el-form-item>
              <el-form-item label="全场满赠-标签">
                <el-input v-model="aiDrawingForm.fullGiftTags" placeholder="赠" />
              </el-form-item>
              <el-form-item label="全场满赠-图片">
                <DevUpLoad v-model="aiDrawingForm.fullGiftImages" :limit="5" />
              </el-form-item>
              <el-form-item label="到手价-标题">
                <el-input v-model="aiDrawingForm.handPriceTitle" placeholder="到手价" />
              </el-form-item>
              <el-form-item label="到手价-价格">
                <el-input v-model="aiDrawingForm.handPrice" placeholder="￥34.3" />
              </el-form-item>
              <el-form-item label="利益点">
                <el-input v-model="aiDrawingForm.profitPoints" placeholder="会员抢券 全场满199-15" />
              </el-form-item>
              <el-form-item label="活动时间">
                <el-input v-model="aiDrawingForm.activityTime" placeholder="活动时间：12/15 00:00:00 - 12/25 23:59:59" />
              </el-form-item>
